...
public class GuestController {
									...
									if (cardType != 1 && cardType != 2 && cardType != 3) {
										...
										println("Please enter a valid credit card type to be updated");
											...
											|| (cardType == 2 && (updateguest.getCard().getType().equals("Master"))
													|| (cardType == 3
															&& (updateguest.getCard().getType().equals("Amex")))))) {
										...
										|| (cardType == 1 && (updateguest.getCard().getType().equals("Visa"))
												|| (cardType == 2 && (updateguest.getCard().getType().equals("Master"))
														|| (cardType == 3
																&& (updateguest.getCard().getType().equals("Amex"))))));
								break;
				...
				case 5:
					...
					do {
						...
						if (country.equals("") || !country.matches(alpha)) {
							...
							|| (country.equals(updateguest.getCountry())));
					break;
	...
	public void searchGuest(String[] args) {
		...
		// do {
		//
		// print("Please select identity type - (1) Driving License (2)
		// Passport: ");
		// identityType = sc.nextInt();
		// sc.nextLine();
		//
		...
		// } while (identityType != 1 && identityType != 2);
		//
		// if (lic.equals(searchguest.getIdentity().getLic()) &&
		// pp.equals(searchguest.getIdentity().getPp())) {
		//
		// for (int i = 0; i < alr.size(); i++) {
		// Guest searchguest = (Guest) alr.get(i);
